...
<!-- ![the Shor syndrome extraction circuit of the Toric(3, 3) instance of this code family](./Toric(3, 3)_shor_syndrome.png) -->
...
<!-- ![the Shor syndrome extraction circuit of the Toric(4, 4) instance of this code family](./Toric(4, 4)_shor_syndrome.png) -->
<!-- TODO: make the above work reliably and uncomment it -->
...
<!-- ![the Shor syndrome extraction circuit of the Toric(6, 6) instance of this code family](./Toric(6, 6)_shor_syndrome.png) -->
<!-- TODO: make the above work reliably and uncomment it -->
...
<!-- ![the Shor syndrome extraction circuit of the Toric(8, 8) instance of this code family](./Toric(8, 8)_shor_syndrome.png) -->
<!-- TODO: make the above work reliably and uncomment it -->
...
<!-- ![the Shor syndrome extraction circuit of the Toric(10, 10) instance of this code family](./Toric(10, 10)_shor_syndrome.png) -->
<!-- TODO: make the above work reliably and uncomment it -->
...
<!-- ![the Shor syndrome extraction circuit of the Toric(12, 12) instance of this code family](./Toric(12, 12)_shor_syndrome.png) -->
<!-- TODO: make the above work reliably and uncomment it -->
